 ...
 */
@RestController
@RequestMapping("/student/daily")
public class StudentDailyController extends BaseController {
    @Autowired
     ...
     * 导出实习考勤信息列表
     */
    @PreAuthorize("@ss.hasPermi('student:daily:export')")
     ...
     * 获取实习考勤信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('student:daily:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增实习考勤信息
     */
    @PreAuthorize("@ss.hasPermi('student:daily:add')")
     ...
     * 修改实习考勤信息
     */
    @PreAuthorize("@ss.hasPermi('student:daily:edit')")
     ...
     * 删除实习考勤信息
     */
    @PreAuthorize("@ss.hasPermi('student:daily:remove')")
