...
public class CompanyHeadController extends BaseController {
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('college:head:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('college:head:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('college:head:import')")
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('college:head:query')")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('college:head:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('college:head:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('college:head:remove')")
     ...
     * 重置密码
     */
    @PreAuthorize("@ss.hasPermi('college:head:resetPwd')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
