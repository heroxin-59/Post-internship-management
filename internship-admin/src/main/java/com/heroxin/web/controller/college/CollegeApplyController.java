 ...
 */
@RestController
@RequestMapping("/college/apply")
public class CollegeApplyController extends BaseController {
    @Autowired
     ...
     * 查询实习申请审核信息列表
     */
    @PreAuthorize("@ss.hasPermi('college:apply:list')")
    @GetMapping("/list")
     ...
     * 导出实习申请审核信息列表
     */
    @PreAuthorize("@ss.hasPermi('college:apply:export')")
     ...
     * 获取实习申请审核信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('college:apply:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增实习申请审核信息
     */
    @PreAuthorize("@ss.hasPermi('college:apply:add')")
     ...
     * 修改实习申请审核信息
     */
    @PreAuthorize("@ss.hasPermi('college:apply:edit')")
     ...
     * 删除实习申请审核信息
     */
    @PreAuthorize("@ss.hasPermi('college:apply:remove')")
