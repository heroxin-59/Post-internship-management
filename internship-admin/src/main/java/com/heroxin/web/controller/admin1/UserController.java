...
public class UserController extends BaseController
{
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('admin1:user:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('admin1:user:import')")
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:query')")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:remove')")
     ...
     * 重置密码
     */
    @PreAuthorize("@ss.hasPermi('admin1:user:resetPwd')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
