...
public class CompanyStudentController extends BaseController {
    @Autowired
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('college:student:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('college:student:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('college:student:import')")
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('college:student:query')")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('college:student:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('college:student:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('college:student:remove')")
     ...
     * 重置密码
     */
    @PreAuthorize("@ss.hasPermi('college:student:resetPwd')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
