 ...
 */
@RestController
@RequestMapping("/company/grades")
public class CompanyGradesController extends BaseController
{
    @Autowired
     ...
     * 查询实习成绩信息列表
     */
    @PreAuthorize("@ss.hasPermi('company:grades:list')")
    @GetMapping("/list")
     ...
     * 导出实习成绩信息列表
     */
    @PreAuthorize("@ss.hasPermi('company:grades:export')")
     ...
     * 获取实习成绩信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('company:grades:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增实习成绩信息
     */
    @PreAuthorize("@ss.hasPermi('company:grades:add')")
     ...
     * 修改实习成绩信息
     */
    @PreAuthorize("@ss.hasPermi('company:grades:edit')")
     ...
     * 删除实习成绩信息
     */
    @PreAuthorize("@ss.hasPermi('company:grades:remove')")
