...
public class CompanyStudentController extends BaseController {
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('company:student:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('company:student:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('company:student:import')")
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('company:student:query')")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('company:student:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('company:student:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('company:student:remove')")
     ...
     * 重置密码
     */
    @PreAuthorize("@ss.hasPermi('company:student:resetPwd')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
